...
// permalink:
// https://optimistic.etherscan.io/address/0x66c4196284837667414d6a4e9e974e0627572909#code#F6
...
interface IClearingHouseConfig is IClearingHouseConfigEvent {
  ...
  /// @return marketTwapInterval MarketTwapInterval is the interval of market twap used for mark
  /// price calculations
  /// @return premiumInterval PremiumInterval is the interval of premium used for mark price
  /// calculations
  function getMarkPriceConfig()
    external
    view
    returns (uint32 marketTwapInterval, uint32 premiumInterval);
}
