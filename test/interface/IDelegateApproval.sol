...
interface IDelegateApproval {
    ...
    function getApprovedActions(address trader, address delegate)
        external
        view
        returns (uint8);
    ...
    function canOpenPositionFor(address trader, address delegate)
        external
        view
        returns (bool);
    ...
    function canAddLiquidityFor(address trader, address delegate)
        external
        view
        returns (bool);
    ...
    function canRemoveLiquidityFor(address trader, address delegate)
        external
        view
        returns (bool);
}
